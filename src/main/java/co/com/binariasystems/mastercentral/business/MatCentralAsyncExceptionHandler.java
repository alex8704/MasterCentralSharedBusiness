package co.com.binariasystems.mastercentral.business;
...
public class MatCentralAsyncExceptionHandler implements AsyncUncaughtExceptionHandler {
	private static final Logger LOGGER = LoggerFactory.getLogger(MatCentralAsyncExceptionHandler.class);
